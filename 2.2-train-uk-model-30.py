"""Train a model with the University of Kentucky dataset (annotated for different tissue types). The model trained is the Segformer for  Semantic Segmentation. """
# Merging of CSVs : Added merge_tile_metadata() to read, merge, and 
# save the tile metadata from the two sources 
# (tile/tile_metadata.csv (UK-Archive) and tile1/tile_metadata1.csv (27 Selected Images)) into one file.
# Run
# python3 2.2-train-uk-model-30.py --dataset-dir /home/bhavesh/ml-work/tiles --save-dir /home/bhavesh/ml-work/30imgs/models
...
def merge_tile_metadata():
    ...
    tile_metadata_2 = Path("/home/bhavesh/ml-work/30imgs/tiles1/tile_metadata1.csv")
    ...
    merged_output_path = Path("/home/bhavesh/ml-work/30imgs/tiles_merged/tile_metadata.csv")
...
def main(args):
    ...
    model_name = "segformer-uk-model-27-mag10"
    ...
    gc.uploadFileToItem(model_item["_id"], save_dir / f"{model_name}.zip")
